...
runexp('mnist', 'vanilla', PRIOR, 'fcn', SIGMAPRIOR, PMIN, LEARNING_RATE, MOMENTUM, LEARNING_RATE_PRIOR, MOMENTUM_PRIOR, delta=DELTA, layers=4, clamping=CLAMPING, delta_test=DELTA_TEST, mc_samples=MC_SAMPLES, train_epochs=TRAIN_EPOCHS, device=DEVICE, perc_train=1.0, perc_prior=0.4, verbose=True, dropout_prob=0.2, channel_type='bec', outage=0.1)
