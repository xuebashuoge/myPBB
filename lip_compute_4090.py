...
compute_lipschitz_parallel('mnist', PRIOR, 'fcn', SIGMAPRIOR, PMIN, LEARNING_RATE_PRIOR, MOMENTUM_PRIOR, layers=4, clamping=CLAMPING, mc_samples=MC_SAMPLES, chunk_size=CHUNK_SIZE, device=DEVICE, prior_epochs=20, dropout_prob=0.2, perc_train=1.0, perc_prior=0.5, batch_size=BATCH_SIZE, verbose=True, channel_type='bec', outage=0.2, l_0=2, seed=7, norm_type=args.norm_type)

compute_lipschitz_parallel('mnist', PRIOR, 'cnn', SIGMAPRIOR, PMIN, LEARNING_RATE_PRIOR, MOMENTUM_PRIOR, layers=4, clamping=CLAMPING, mc_samples=MC_SAMPLES, chunk_size=CHUNK_SIZE, device=DEVICE, prior_epochs=70, dropout_prob=0.2, perc_train=1.0, perc_prior=0.5, batch_size=BATCH_SIZE, verbose=True, channel_type='bec', outage=0.2, l_0=2, seed=7, norm_type=args.norm_type)

compute_lipschitz_parallel('cifar10', PRIOR, 'cnn', SIGMAPRIOR, PMIN, LEARNING_RATE_PRIOR, MOMENTUM_PRIOR, layers=9, clamping=CLAMPING, mc_samples=MC_SAMPLES, chunk_size=CHUNK_SIZE, device=DEVICE, prior_epochs=20, dropout_prob=0.2, perc_train=1.0, perc_prior=0.5, batch_size=BATCH_SIZE, verbose=True, channel_type='bec', outage=0.2, l_0=4, seed=7, norm_type=args.norm_type)
