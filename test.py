...
parser.add_argument('--objective', type=str, default='vanilla', help='The training objective to use (e.g., "vanilla", "bbb", "channel")')

parser.add_argument('--channel_penalty', type=float, default=1.0, help='The penalty for channel objective (default: 1.0)')

parser.add_argument('--kl_penalty', type=float, default=1.0, help='The KL penalty to use (default: 1.0)')
